                         ...
                         poly2: b2PolygonShape, xf2: b2Transform) -> (edgeIndex: Int, maxSeparation: b2Float)
{
  ...
  var bestIndex = 0
    var maxSeparation = -b2Settings.Instance.b2_maxFloat
  for i in 0 ..< count1 {
    ...
    // Find deepest point for normal i.
      var si = b2Settings.Instance.b2_maxFloat
    for j in 0 ..< count2 {
                        ...
                        poly2: b2PolygonShape, xf2: b2Transform) -> [b2ClipVertex]
{
  ...
  var index = 0
    var minDot = b2Settings.Instance.b2_maxFloat
  for i in 0 ..< count2 {
  ...
  polygonB polyB: b2PolygonShape, transformB xfB: b2Transform)
{
  ...
  var flip: Bool
    let k_tol: b2Float = 0.1 * b2Settings.Instance.b2_linearSlop
